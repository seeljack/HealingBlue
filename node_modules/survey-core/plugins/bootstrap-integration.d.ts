...
declare module "bootstrap/cssbootstrap" {
...
declare module "bootstrap/theme-settings" {
...
declare module "bootstrap/index" {
    export * from "bootstrap/theme-settings";
    export * from "bootstrap/cssbootstrap";
}

declare module "survey-core/plugins/bootstrap-integration" { import main = require("bootstrap/index"); export = main; }